...
export default function OfficialsFilterBar({
  ...
  const hasActiveFilters = searchQuery !== '' || roleFilter !== '' || termFilter !== '';
    ...
    <div className="space-y-4">
      ...
      <div className="relative">
        <input
          ...
          className="w-full rounded-lg border border-slate-300 bg-white px-4 py-2.5 pl-10 text-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
        />
        <svg
